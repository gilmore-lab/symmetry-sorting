...
generate_n_sorting_permutations <-
  function(wp_group = "P1",
           n_permutations = 5) {
    csv_in <- file.path(params$data_dir, paste0(wp_group, "-sorting.csv"))
    ...
    for (p in 1:n_permutations) {
      csv_out <-
        file.path(params$data_dir,
          "permutation_analysis", "sorting_csv",
          paste0(wp_group,
          "-sorting-perm-",
...
make_jaccard_csvs <- function(wallpaper_group = "P1",
                              duplicates = FALSE,
                              input_dir = file.path(params$data_dir, 'permutation_analysis/sorting_csv/'),
                              output_dir = file.path(params$data_dir, 'permutation_analysis/jaccards/')) {
  # Makes a data.frame from the raw sorting data
  
  # Load externals
  source(file.path(params$code_dir, "jaccard.data.R"))
  source(file.path(params$code_dir, "jaccard.R"))
...
calculate_save_jaccard_df <- function(this_csv,
                                      wallpaper_group,
                                      save_output = TRUE,
                                      jaccard_dir = file.path(params$data_dir, "permutation_analysis/jaccards/"),
                                      vb = FALSE) {
...
make_aggregate_perm_jaccard_df <- function(wp_group = "P1",
                                           input_dir = file.path(params$data_dir, "permutation_analysis", "jaccards"),
                                           save_csv = TRUE,
                                           output_dir = file.path(params$data_dir, "permutation_analysis", "aggregates"),
                                           vb = TRUE) {
  these_csvs <-
...
```{r open-P1-perm}
P1_perm_df <- readr::read_csv(file.path(params$data_dir, "permutation_analysis", "aggregates", "P1-aggregate-perm-jaccard.csv"))
```
...
```{r open-P31M-perm}
P31M_perm_df <- readr::read_csv(file.path(params$data_dir, "permutation_analysis", "aggregates", "P31M-aggregate-perm-jaccard.csv"))
```
...
```{r open-P3M1-perm}
P3M1_perm_df <- readr::read_csv(file.path(params$data_dir, "permutation_analysis", "aggregates", "P3M1-aggregate-perm-jaccard.csv"))
```
...
```{r open-P6-perm}
P6_perm_df <- readr::read_csv(file.path(params$data_dir, "permutation_analysis", "aggregates", "P6-aggregate-perm-jaccard.csv"))
```
...
```{r open-P6M-perm}
P6M_perm_df <- readr::read_csv(file.path(params$data_dir, "permutation_analysis", "aggregates", "P6M-aggregate-perm-jaccard.csv"))
```
...
```{r}
jaccard_observed_df <-
  readr::read_csv(file.path(params$data_dir, "jaccard-no-duplicates.csv"))
