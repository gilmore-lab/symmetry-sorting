...
%DIF ADD wallpaper_sort_symmetry_revised.tex   Thu Mar 31 20:56:50 2022
\usepackage{boisik}
...
\DIFaddbegin \begin{table}[H]
	...
	\textit{\DIFaddFL{P1 vs P31M}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline 
	\textit{\DIFaddFL{P1 vs P3M1}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P1 vs P6}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P1 vs P6M}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P31M vs P3M1}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P31M vs P6}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P31M vs P6M}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P3M1 vs P6}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P3M1 vs P6M}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\textit{\DIFaddFL{P6 vs P6M}} & \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }& \DIFaddFL{1 }& \DIFaddFL{2 }& \DIFaddFL{3 }\\ \hline
	\end{tabular}
	\caption{\DIFaddFL{Results of post-hoc pairwise }\textit{\DIFaddFL{t}}\DIFaddFL{-tests on number of sets and Jaccard Indices. Degrees-of-freedom for all tests was xx.}}
	\label{table:t-stats}
\end{table}
